<template>
  <div>
    ...
    <div class="hero is-dark custom-dimens">
      <div id="game-columns">
        <Scores />
        <div id="drawing-column" class="span-col-5 span-row-85">
          ...
          <div id="gray-bg" v-else style="height:600px">
            <div v-if="show_scoreboard" id="scoreboard" style="height:600px">
              <div v-if="is_final_scoreboard" id="winner_name" style="height:100%">
                <h1>
                  {{ players[0].username }} {{ $t("chat_evt.player_won") }}
                </h1>
              </div>
              <div
              ...
              >
                ...
                <div
                  v-if="player.points_gained && player.points_gained != 0"
                  class="points_gained"
                >
            ...
            <div v-else style="height:600px">
              <div id="ready_wait" v-if="ready_wait">
                <h3 id="chosen_word" v-if="localPlayer == painter">
                  {{ word }}
                </h3>
                <h2>{{ ready_sec }}</h2>
              </div>
...
export default {
  ...
  computed: {
    ...
    leave_link: () => {
      let leave_link = "http://localhost:8080";
      return leave_link;
    },
  },
  mounted() {
